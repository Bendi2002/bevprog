...
constexpr char roots = 's';
constexpr char powers = 'p';
	...
	switch (ch)
	{
    	...
    	default:
    	{
    		if (isalpha(ch))
    		{
    			...
    			if (s == root) return Token{roots};
    			if (s==power) return(powers);
...
int main(){
try {
cout<<"Hello! This is a calculator program! Use these symbols + - * / pi e sqrt pow ( ) % for your calculation."<<endl;
